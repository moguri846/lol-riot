    ...
    <S.SignInOrUpContainer>
      ...
      {signIn && (
        <>
          ...
          <S.OAuthButtons>
            <a
              href={`https://kauth.kakao.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_KAKAO_CLIENT_ID}&redirect_uri=${process.env.VITE_KAKAO_REDIRECT_URI}&response_type=code`}
            >
